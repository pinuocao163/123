...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_model', default='GRU', help='base model, LSTM/GRU/Linear')
    ...
    parser.add_argument('--valid_rate', type=float, default=0.0, metavar='valid_rate', help='valid rate, 0.0/0.2')
